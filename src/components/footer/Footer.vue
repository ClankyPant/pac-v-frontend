<template>
  <v-footer dark padless>
    <v-card class="flex" flat tile color="#142245">
      <v-row>
        <v-col md="4">
          <v-card class="pa-2" outlined tile color="#142245">
            <v-card-text class="white--text text-left" style="font-size: 18px">
              <strong>RACCON GAMES</strong>
            </v-card-text>
            ...
            <v-card-text class="white--text text-left">
              ...
              <strong>Raccon Games | Todos os direitos reservados.</strong>
            </v-card-text>
          </v-card>
        </v-col>
